...
class CustomProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        **ctx: Any,
        ...
        # native `think` field but DOES honor top-level `reasoning_effort: "none"`,
        # so we send BOTH: `think` (extra_body, native /api path) and
        # `reasoning_effort` (top-level, the /v1 path that actually works).
        thinking_off = True
